...
motor LiftUpMotorMotorA = motor(PORT3, ratio36_1, false);
motor LiftUpMotorMotorB = motor(PORT4, ratio36_1, false);
motor_group LiftUpMotor = motor_group(LiftUpMotorMotorA, LiftUpMotorMotorB);
